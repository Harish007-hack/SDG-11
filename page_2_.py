...
'''This is the Video and Graphics Page
...
"")
        ...
        self.pushButton_15.setMaximumSize(QtCore.QSize(277, 147))
        self.pushButton_15.setText("")
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap("thumbnail1 (3).jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_15.setIcon(icon14)
        self.pushButton_15.setIconSize(QtCore.QSize(277, 147))
        self.pushButton_15.setObjectName("pushButton_15")
        self.horizontalLayout_12.addWidget(self.pushButton_15)
        self.pushButton_16 = QtWidgets.QPushButton(self.frame_13)
        self.pushButton_16.setMaximumSize(QtCore.QSize(277, 182))
        self.pushButton_16.setText("")
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap("thun2 (1).jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_16.setIcon(icon15)
        self.pushButton_16.setIconSize(QtCore.QSize(277, 182))
...
"")
        ...
        self.horizontalLayout_13.addWidget(self.label_8, 0, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignTop)
        ...
        self.horizontalLayout_13.addWidget(self.label_9, 0, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignTop)
...
"background:transparent")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "Graphics & Video Presentation"))
        self.label_8.setText(_translate("MainWindow", "Lecture On Importance Of Goal 11"))
        self.label_9.setText(_translate("MainWindow", "Future Cars Based Goal11"))
        self.label_7.setText(_translate("MainWindow", "More Video Lessons and Stock Graphics will be added Soon"))
